...
from reversi_zero.config import ModelConfig
...
class ReversiEnv:
    def __init__(self):
        ...
        self._board_history = deque(maxlen=ModelConfig.history_len)
    ...
    def rotate_flip_pi(self, pi, op):
        ...
        part_pi = np.asarray(pi).reshape(8, 8)
